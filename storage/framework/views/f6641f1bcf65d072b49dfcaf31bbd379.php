...
<head>
    ...
    <title><?php echo e(config('app.name', 'TeamBoard')); ?> - Register</title>
...
<body class="font-body antialiased">
    <div class="min-h-screen flex">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 lg:p-12 bg-white relative overflow-y-auto">
            <!-- Mobile logo -->
            <a href="<?php echo e(route('landing')); ?>" class="lg:hidden flex items-center gap-3 mb-6">
            ...
            <div class="w-full max-w-md">
                ...
                <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-5" id="registerForm">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-6 text-center">
                    <p class="text-gray-600">
                        ...
                        <a href="<?php echo e(route('login')); ?>" class="font-semibold text-[#2d6a4f] hover:text-[#40916c] transition-colors hover:underline">
                            Sign in
                        </a>
                    </p>
                </div>
...
<?php /**PATH C:\Users\hagga\Documents\GitHub\TeamBoard\resources\views/auth/register.blade.php ENDPATH**/ ?>