...
<body class="font-sans antialiased bg-background">
    <div class="min-h-screen flex">
        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-border transform -translate-x-full lg:translate-x-0 lg:static lg:inset-auto transition-transform duration-300 ease-in-out flex flex-col">
            ...
            <div class="h-16 flex items-center justify-between px-6 border-b border-border">
                <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3 group">
                    ...
                    <span class="text-xl font-bold text-foreground tracking-tight">TeamBoard</span>
                </a>
            </div>
        ...
        <div class="flex-1 flex flex-col min-h-screen lg:ml-0">
            <!-- Top Navbar -->
            <header class="h-16 bg-white/80 backdrop-blur-md border-b border-border sticky top-0 z-30">
                <div class="h-full px-4 sm:px-6 lg:px-8 flex items-center justify-between">
                    <!-- Mobile Menu Button -->
                    <button id="mobile-sidebar-toggle" class="lg:hidden p-2 rounded-lg hover:bg-accent/50 transition-colors">
                    ...
                    <div class="flex-1 max-w-md mx-4 hidden sm:block">
                        <div class="relative">
                            ...
                            <input type="text" placeholder="Search..." class="w-full pl-10 pr-4 py-2 rounded-xl border border-border bg-background/50 focus:bg-white focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all duration-200">
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-3">
                        <!-- Notifications -->
                        <button class="relative p-2 rounded-xl hover:bg-accent/50 transition-all duration-200 group">
                        ...
                        <!-- Quick Add -->
                        <div x-data="{ open: false }" class="relative">
                            <button @click="open = !open" class="p-2 rounded-xl bg-primary text-white hover:bg-primary/90 transition-all duration-200 shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-0.5 active:translate-y-0">
