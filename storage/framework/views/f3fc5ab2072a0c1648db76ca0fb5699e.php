        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-72 sidebar-gradient border-r border-gray-100 transform -translate-x-full lg:translate-x-0 lg:static lg:inset-auto transition-transform duration-300 ease-in-out flex flex-col shadow-xl lg:shadow-none">
            ...
            <div class="h-20 flex items-center justify-between px-6 border-b border-gray-100">
                <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3 group">
                    <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-[#86e7b8] to-[#2d6a4f] flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-105 glow-primary">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto custom-scrollbar">
                ...
                <a href="<?php echo e(route('employees.index')); ?>" class="sidebar-nav-link <?php echo e(request()->routeIs('employees.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('notices.index')); ?>" class="sidebar-nav-link <?php echo e(request()->routeIs('notices.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('documents.index')); ?>" class="sidebar-nav-link <?php echo e(request()->routeIs('documents.*') ? 'active' : ''); ?>">
            ...
            <header class="h-20 bg-white/80 backdrop-blur-xl border-b border-gray-100 sticky top-0 z-30 shadow-sm">
                <div class="h-full px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
                    ...
                    <div class="hidden lg:flex items-center gap-3">
                        ...
                        <div>
                            <h1 class="font-display text-lg font-bold text-gray-900"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></h1>
                            <p class="text-xs text-gray-500">Welcome back, <?php echo e(auth()->user()->name ?? 'User'); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-2 sm:gap-3">
                        ...
                        <div x-data="{ open: false }" class="relative">
                            ...
                            <div x-show="open"
                                ...
                                <a href="<?php echo e(route('notices.create')); ?>" class="flex items-center gap-3 px-4 py-3 text-sm text-gray-700 hover:bg-[#86e7b8]/10 transition-colors">
                                ...
                                <a href="<?php echo e(route('documents.create')); ?>" class="flex items-center gap-3 px-4 py-3 text-sm text-gray-700 hover:bg-[#86e7b8]/10 transition-colors">
                                ...
                                <?php if(auth()->guard()->check()): ?>
                                    <?php if(auth()->user()->isAdmin()): ?>
                                        ...
                                        <a href="<?php echo e(route('employees.create')); ?>" class="flex items-center gap-3 px-4 py-3 text-sm text-gray-700 hover:bg-[#86e7b8]/10 transition-colors">
                ...
                <?php if(session('success')): ?>
                    <div data-success-message class="mb-6 rounded-xl bg-[#86e7b8]/20 border border-[#86e7b8]/30 p-4 animate-slide-up" onclick="triggerConfetti()">
                        <div class="flex items-center gap-3">
                            ...
                            <p class="text-sm font-medium text-[#1b4332]"><?php echo e(session('success')); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
            ...
            <footer class="py-6 px-6 border-t border-gray-100 bg-white/50 backdrop-blur-sm">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                    <p class="text-sm text-gray-500">
                        &copy; <?php echo e(date('Y')); ?> TeamBoard. Built with <span class="text-red-500">♥</span> for teams.
                    </p>
...
</html><?php /**PATH C:\Users\hagga\Documents\GitHub\TeamBoard\resources\views/layouts/app.blade.php ENDPATH**/ ?>