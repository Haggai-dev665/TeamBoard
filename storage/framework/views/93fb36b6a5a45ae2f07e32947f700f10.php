...
<head>
    ...
    <title><?php echo e(config('app.name', 'TeamBoard')); ?> - Login</title>
    ...
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 auth-gradient relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col justify-center items-center w-full p-12">
                <!-- Logo -->
                <a href="<?php echo e(route('landing')); ?>" class="absolute top-8 left-8 flex items-center gap-3 group">
                    <div class="bg-white/90 backdrop-blur-sm p-3 rounded-xl shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-105">
                        <img src="<?php echo e(asset('assets/logo.png')); ?>" alt="TeamBoard Logo" class="w-8 h-8 object-contain">
                    </div>
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 lg:p-16 bg-white relative">
            <!-- Mobile logo -->
            <a href="<?php echo e(route('landing')); ?>" class="lg:hidden flex items-center gap-3 mb-8">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-6 text-center">
                    <p class="text-gray-600">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="font-semibold text-[#2d6a4f] hover:text-[#40916c] transition-colors hover:underline">
                            Create an account
                        </a>
                    </p>
                </div>
                ...
                <div class="mt-8 text-center">
                    <a href="<?php echo e(route('landing')); ?>" class="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-[#2d6a4f] transition-colors">
...
<?php /**PATH C:\Users\hagga\Documents\GitHub\TeamBoard\resources\views/auth/login.blade.php ENDPATH**/ ?>