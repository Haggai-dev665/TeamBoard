        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center gap-4">
                    <a href="<?php echo e(route('login')); ?>" class="text-foreground hover:text-primary transition-colors font-medium hidden sm:block">
                        Login
                    </a>
                    <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-300 bg-primary text-primary-foreground shadow-lg hover:shadow-xl hover:bg-primary/90 h-10 px-6 hover:-translate-y-0.5">
                        Get Started
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-center lg:text-left">
                    ...
                    <div class="animate-fade-in-up delay-400 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <a href="<?php echo e(route('register')); ?>" onclick="triggerConfetti()" class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-base font-semibold transition-all duration-300 bg-primary text-primary-foreground shadow-lg hover:shadow-2xl hover:bg-primary/90 h-14 px-8 hover:-translate-y-1 animate-pulse-glow">
                            Start Free Trial
    ...
    <section class="py-20 lg:py-32 bg-gradient-to-br from-primary via-accent to-primary relative overflow-hidden">
        ...
        <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('register')); ?>" onclick="triggerConfetti()" class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-base font-semibold transition-all duration-300 bg-white text-primary shadow-2xl hover:shadow-3xl h-14 px-10 hover:-translate-y-1">
                    Get Started for Free
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path>
                    </svg>
                </a>
                <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-base font-semibold transition-all duration-300 bg-white/20 backdrop-blur-sm text-white border-2 border-white/50 h-14 px-10 hover:-translate-y-1 hover:bg-white/30">
                    Login to Dashboard
                </a>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="border-t border-white/10 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
                <p class="text-sm text-white/60">
                    &copy; <?php echo e(date('Y')); ?> TeamBoard. All rights reserved.
                </p>
                <div class="flex items-center gap-4">
...
<?php /**PATH C:\Users\hagga\Documents\GitHub\TeamBoard\resources\views/landing.blade.php ENDPATH**/ ?>